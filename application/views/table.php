      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()?>index.php/User/form"><i class="fa fa-circle-o"></i> Form User</a></li>
          </ul>
           <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url()?>index.php/user"><i class="fa fa-circle-o"></i> Data User</a></li>
          </ul>
        </li>
